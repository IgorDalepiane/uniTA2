...
public class EnderecoDAO implements InterfaceDAO {
     ...
     */
    public boolean inserir(Endereco end) throws SQLException {
     ...
     * @return true se a operação foi concluída com sucesso, false se não
     */
    public boolean remover(Endereco end) throws SQLException {
     ...
     */
    public Endereco buscar(Endereco end) throws SQLException {
...
//    }
     ...
     * @return o registro
     */
    public Endereco buscarUltimoEnd() throws SQLException {
